...
def setup():
    ...
    api_key = input("\n\033[96mEnter your Groq API Key (from console.groq.com):\033[0m\n> ").strip()
    
    if not api_key.startswith("gsk_"):
        print("\033[93m[WARNING] That doesn't look like a valid Groq API Key (typically starts with gsk_). Proceed anyway? (y/n)\033[0m")
        if input("> ").lower() != 'y':
...
"""
    ...
    try:
        import groq
        print("\033[92m[OK] Groq library found.\033[0m")
    except ImportError:
        print("\033[93m[INFO] Groq library missing. Running automatic installation...\033[0m")
        import subprocess
